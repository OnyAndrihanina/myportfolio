          ...
          <div className="modal-content border-0 rounded-0">
            <div className="modal-header bg-light px-5 pt-0 pb-5">
              <div className="ts-title mb-0">
                ...
                <h4 className="mb-0">{data.description3[language]}</h4>
              </div>
            ...
            <div className="modal-body p-5">
              ...
              <span style={{ fontStyle: 'italic', color: '#343a40' ,fontSize : '14px'}}>Inclusiv Academy</span>
              </h5>
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div className="col-md-4">
                        <img src="./public/assets/img/dechet.png" alt="" />
                      </div>
                      <div className="col-md-8">
                        <h4 className="mb-3">Tamana</h4>
                        <p>
                        {data.dechetstatut[language]} <br />
                          {data.readmorewebdev[language]}
                        </p>
                        <a href="https://gitlab.com/SoavaNyAnjara/tamana" className="mb-4 text-dark d-block">
